...
draw_title_screen :: proc(delta:f32) {
	...
	logo_dst := rl.Rectangle{mid.x - logo_draw_size.x / 2, mid.y - logo_draw_size.y / 2 - 60, logo_draw_size.x, logo_draw_size.y}
	rl.DrawTexturePro(logo_texture, {0, 0, f32(logo_texture.width), f32(logo_texture.height)}, logo_dst, {0, 0}, 0, rl.WHITE)
