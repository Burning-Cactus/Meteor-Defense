...
flags="-sEXPORTED_RUNTIME_METHODS=['HEAPF32'] -sUSE_GLFW=3 -sWASM_BIGINT -sWARN_ON_UNDEFINED_SYMBOLS=0 -sASSERTIONS --shell-file ${SOURCE_DIR}/main_web/index_template.html -sFORCE_FILESYSTEM=1"
if $DEBUG; then
    flags+=" -g"
fi
